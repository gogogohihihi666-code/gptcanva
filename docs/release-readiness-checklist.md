...
- Follow-up clean-browser diagnosis used both a fresh Playwright context and a fresh temporary Chrome profile at 1280px and 390px. All checked public and protected-route entry states rendered visible content, preserved expected safe redirects, had no console or resource errors, and had no horizontal overflow. The earlier blank state was `STALE_BROWSER_STATE`; no source fix was required.
