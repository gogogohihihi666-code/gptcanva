...
export const MARKETING_CENTER_PAYMENT_SECRET_PREFLIGHT_PATH = MARKETING_CENTER_BASE_PATH + '/payment-secret-preflight'
...
export const isMarketingCenterPath = (requestPath: string) => {
  return requestPath === MARKETING_CENTER_OVERVIEW_PATH
    ...
    || requestPath === MARKETING_CENTER_PAYMENT_SECRET_PREFLIGHT_PATH
